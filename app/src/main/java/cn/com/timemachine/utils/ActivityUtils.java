...
public final class ActivityUtils {
    ...
    public static void finishOtherActivities(@NonNull final Class<?> clz,
        ...
        List<Activity> activities = AppUtils.sActivityList;
    ...
    public static Drawable getActivityIcon(final Class<?> clz) {
        return getActivityIcon(new ComponentName(AppUtils.getApp(), clz));
    }
    ...
    public static Activity getTopActivity() {
        if (AppUtils.sTopActivityWeakRef != null) {
            Activity activity = AppUtils.sTopActivityWeakRef.get();
            if (activity != null) {
                return activity;
            }
        }
