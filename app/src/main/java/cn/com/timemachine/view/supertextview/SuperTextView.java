package cn.com.timemachine.view.supertextview;
...
public class SuperTextView extends RelativeLayout {
    ...
    public   void setTextBackground(Drawable bg){
        rightView.setBackground(bg);
    }
     ...
     * @param background
     */
    public void setDefaultBackground(TextView textView, Drawable background) {
        if (background != null) {
            textView.setVisibility(VISIBLE);
            if (Build.VERSION.SDK_INT < 16) {
